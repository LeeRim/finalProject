        ...
        <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <c:forEach items="${sessionScope.indexNote}" var="note">
                  <li><!-- start message -->
                    <a href="receiveNoteDetail.do?snKey=${note.snKey}&rnKey=${note.rnKey}" ">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="resources/upload/empPhoto/${note.ePhoto}" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="resources/upload/empPhoto/${sessionScope.user.ePhoto}" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><c:out value="${sessionScope.user.eName}"/></span>
            </a>
            <ul class="dropdown-menu">
